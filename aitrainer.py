...
window.title("bodybuilder_banja")
...
classLabel.configure(text='Current stage') 
...
counterLabel.configure(text='Total Reps') 
probLabel  = ck.CTkLabel(window, height=40, width=120, text_font=("Arial", 20), text_color="black", padx=10)
probLabel.place(x=300, y=1)
probLabel.configure(text='Probablity') 
classBox = ck.CTkLabel(window, height=40, width=120, text_font=("Arial", 20), text_color="white", fg_color="red")
classBox.place(x=10, y=41)
classBox.configure(text='0') 
counterBox = ck.CTkLabel(window, height=40, width=120, text_font=("Arial", 20), text_color="white", fg_color="red")
counterBox.place(x=160, y=41)
counterBox.configure(text='0') 
probBox = ck.CTkLabel(window, height=40, width=120, text_font=("Arial", 20), text_color="white", fg_color="red")
...
with open((r"C:\Users\Dr Poonam Pandey\Desktop\projects\ai fitness trainer\deadlift.pkl"), 'rb') as f: 
    model = pickle.load(f) 
